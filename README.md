...
* Criando um tópico no [fórum do GitHub](https://github.com/Boleto Simples/boletosimples-woocommerce/issues).
...
Você pode contribuir com código-fonte em nossa página no [GitHub](https://github.com/Boleto Simples/boletosimples-woocommerce).
...
1. Crie uma conta e contrate um Plano Pago no [Boleto Simples](http://boletosimples.com.br/planos/);
2. Com a conta é possível gerar um Token em [Boleto Simples - Minhas informações](https://app.boletosimples.com.br/myinfo);
3. E finalmente crie uma notificação em [Boleto Simples - Notificações](https://app.boletosimples.com.br/web_hooks/new);
4. Na notificação criada:;
5. Escolha o evento 'Pago';
6. Escolha a situação 'Ativo';
7. Crie um **Código de Segurança**;
8. E configure a **URL para notificação** como por exemplo `http://seusite.com.br/?wc-api=WC_BoletoSimples_Gateway`;
...
* Com a conta é possível gerar um Token em [Boleto Simples - Minhas informações](https://app.boletosimples.com.br/myinfo);
* E finalmente crie uma notificação em [Boleto Simples - Notificações](https://app.boletosimples.com.br/web_hooks/new);
...
O Boleto Simples é um sistema que funciona na web, feito para que qualquer pessoa possa gerar boletos bancários e gerenciar suas cobranças. Com o Boleto Simples é possível cadastrar os dados da cobrança que ele gera o boleto bancário para ser enviado para o cliente pagar. Os bancos possuem seus próprios sistemas para isso, mas no Boleto Simples é possível emitir boletos para diversos bancos e gerenciar todas as cobranças em um só lugar. Além de possuir diversos recursos que outros sistemas não oferecem.
...
### Alterar os parametros postados para o Boleto Simples: ###
	...
	function custom_woocommerce_boletosimples_billet_data( $data, $order ) {
		...
		// Api do Boleto Simples: https://github.com/Boleto Simples/boletosimples-api
